...
- [ ] Push and redeploy `main` with the title-following slugs, live demo sandbox, and responsive fixes (commits `d290c1c`–`73a1d54`). No migrations are pending; run `bun run deploy` and smoke-test `/demo` plus the owner flows.
